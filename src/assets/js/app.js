...
class App extends AppHelpers {
  ...
  loadTheApp() {
    ...
    this.initStickyHeader(); // Add custom sticky header functionality
    initTootTip();
  ...
  initSearchOverlay() {
    ...
    document.addEventListener("click", (e) => {
      const searchBtn = e.target.closest("[data-search-toggle]");
      ...
      if (searchBtn) {
        ...
        if (searchOverlay) {
          ...
          console.log("Search overlay opened - scrolling disabled");

          // Focus on search input after a short delay
          setTimeout(() => {
            const searchInput = searchOverlay.querySelector(
              'input[type="search"], salla-search input, input'
            );
            if (searchInput) {
              searchInput.focus();
      ...
      if (closeBtn) {
        ...
        if (searchOverlay) {
          ...
          console.log("Search overlay closed - scrolling enabled");
        }
      }
      ...
      if (searchOverlay && e.target === searchOverlay) {
        ...
        document.body.style.overflow = "";
        console.log(
          "Search overlay closed by background click - scrolling enabled"
        );
      }
    });
    ...
    document.addEventListener("keydown", (e) => {
      if (e.key === "Escape") {
        ...
        if (searchOverlay && searchOverlay.style.display !== "none") {
          ...
          document.body.style.overflow = "";
          console.log(
            "Search overlay closed by Escape key - scrolling enabled"
          );
        }
      }
    });
  ...
  /**
   * Initialize sticky header with shadow effect on scroll
   */
  initStickyHeader() {
